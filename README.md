...
[![My Skills](https://skillicons.dev/icons?i=js,react,html,css,nodejs,express,mongodb,firebase,sqlite,flutter,dart,java,py,git,docker,gitlab,github,webpack,postman,npm,maven,vitest,redux,fastapi,postgres,nextjs,debian)](https://skillicons.dev)
