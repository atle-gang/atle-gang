...
[![My Skills](https://skillicons.dev/icons?i=js,react,html,css,nodejs,express,mongodb,firebase,flutter,dart,java,py,git,docker,gitlab,github,npm,maven,vitest,redux,ts,fastapi,postgres,nextjs,debian)](https://skillicons.dev)
